...
public class LoggingInterceptor extends HandlerInterceptorAdapter{
	...
	static String logMP[] = {"iphone","ipod","android","blackberry","opera mobile"};
	/*
	 * 모든 경로로 들어오는 요청정보에 대한 로그정보를 남기기위한 메소드
	 */
	@Override
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception{
		...
		logger.info(ip+": "+currentDevice+": "+userId+": "+protocol+"//"+currentDomain+":"+currentPort+uri+(queryString != null ? "?"+queryString : ""));
