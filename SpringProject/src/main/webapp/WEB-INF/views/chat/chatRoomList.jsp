...
<div class="content">
      ...
      <div class="innerOuter" style="padding : 5% 10%; width:100%;">
         ...
         <c:if test="${!empty loginUser }">
            <div class="btn-area">
               <button data-toggle="modal" data-target="#chatModal" class="btn btn-danger">채팅방만들기</button>
            </div>
         </c:if>
      </div>
      <br><br>
   ...
   <div class="modal fade" id="chatModal">
      <div class="modal-dialog modal-sm">
         <div class="modal-content">
            ...
            <form action="${pageContext.request.contextPath }/chat/openChatRoom" method="post">
               <!--  모달 바디 -->
