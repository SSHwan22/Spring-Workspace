...
<!-- 		<div id="header_1"> -->
			<div id="header_1_left">
			 <a href="${contextPath}">
		    	...
		    	pageContext.request.contextPath 구하는 방법 
		  		1) /spring --> 하드코딩시 : 컨텍스트이름이 변경될경우 일일이 찾아서 수정해줘야하는 번거로움이 있다.
		   		2) <%=  request.getpageContext.request.contextPath() %> --> 화면안에 자바코드가 혼합되어 프론트페이지가 지저분해지는 단점있따.
		    	3) ${pageContext.servletContext.pageContext.request.contextPath } --> 자바코드를 사용하지 않고 el표현식을 활용하게될시 화면을 좀더 깔끔하게 꾸밀수 있찌만, pageContext.request.contextPath를 구하기 위한 경로가 너무
		    												길어 작성하기 번거롭다.
		    			    	
		    	따라서 application scope에 최상위 주소를 간단히 부를 수 있는 형태로 저장할 예정!
		    	 --%>
		        <img src="${contextPath}/resources/images/top_logo.jpg">
