	...
	<div class="content">
		...
		<div class="innerOuter" style="padding: 5% 10%;">
			...
			<c:if test="${not empty loginUser}">
				<a class="btn btn-secoundary" style="float:right;" href="${contextPath}/board/enrollForm/${boardCode}">글쓰기</a>
			</c:if>
			<br><br>
	        ...
	        <form id="searchForm" action="${boardCode}" method="get" align="center">
	        	<div class="select">
	        		<select class="custom-select" name="condition">
	        			<option value="writer" ${param.condition == 'writer' ? 'checked': ''}>작성자</option>
